...
![Fig.2 Node Failure Probability vs. Retrieval Latency](Figures/Node Error Rate vs latency.png "Fig.2 Node Failure Probability vs. Retrieval Latency")
...
![Fig.3 Index Maintenance Overhead due to Node Failures](Figures/Node Error vs communication.png "Fig.3 Index Maintenance Overhead due to Node Failures")

**Fig.3** The overhead of index maintenance caused by node failures.

## Addition of New Nodes
![Fig.4 Impact of New Node Addition on Retrieval Latency](Figures/Node Add vs latency.png "Fig.4 Impact of New Node Addition on Retrieval Latency")
...
![Fig.5 Impact of New Node Addition on Deduplication Ratio](Figures/Node Add vs Dedup.png "Fig.5 Impact of New Node Addition on Deduplication Ratio")
...
![Fig.6 Index Maintenance Overhead due to New Node Addition](Figures/Node Add vs communication.png "Fig.6 Index Maintenance Overhead due to New Node Addition")
...
![Fig.7 Impact of Network Disruptions on Retrieval Latency](Figures/Node Error Rate vs latency.png "Fig.7 Impact of Network Disruptions on Retrieval Latency")
...
![Fig.8 Impact of Network Disruptions on Deduplication Ratio](Figures/Node Error Rate vs Dedup.png "Fig.8 Impact of Network Disruptions on Deduplication Ratio")
...
![Fig.9 Decision Time of Distributed vs. Centralized Deduplication Methods](Figures/Server Num vs decision.png "Fig.9 Decision Time of Distributed vs. Centralized Methods")

**Fig.9** Decision time comparison.

![Fig.10 Execution Time of Distributed vs. Centralized Deduplication Methods](Figures/Server Num vs execute.png "Fig.10 Execution Time of Distributed vs. Centralized Methods")
...
![Fig.11 Total Deduplication Time of Distributed vs. Centralized Deduplication Methods](Figures/Server Num vs Deduplication Time.png "Fig.11 Total Deduplication Time")
...
![Fig.12 Alpha Parameter vs. Retrieval Latency](Figures/alpha vs latency.png "Fig.12 Alpha Parameter vs. Retrieval Latency")

**Fig.12** The effect of the alpha parameter on retrieval latency.

![Fig.13 Alpha Parameter vs. Deduplication Ratio](Figures/alpha vs max_dedup.png "Fig.13 Alpha Parameter vs. Deduplication Ratio")
...
![Fig.14 Network Density vs. Average LSS and LDS Storage Space](Figures/density vs memory.png "Fig.14 Network Density vs. Average LSS and LDS Storage Space")
